 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double = ((sagenes * 48) + vershoks + (arshins * 16)) * 4.445 / 100
 ...
 */
fun accountInThreeYears(initial: Int, percent: Int): Double = ((initial + initial*percent/100.0)*(percent/100.0+1.0))*(percent/100.0+1.0)
